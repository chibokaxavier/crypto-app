...
const Navbar = () => {
  ...
  return (
    <div className="w-[100%] shadow-2xl rounded-lg mx-auto flex items-center justify-between h-20 font-bold px-4">
      ...
      <div onClick={handleNav} className="block md:hidden cursor-pointer z-10 mr-4">
       {nav ?  <AiOutlineClose size={25} />: <AiOutlineMenu size={25} />}
      </div>

      {/* mobile menu */}
      <div className={nav?"md:hidden fixed left-0 top-20 flex flex-col justify-between w-full  h-[70%] ease-in duration-300  z-10" : "fixed left-[-100%] top-20 flex flex-col justify-between w-full  h-[70%] ease-in duration-300  z-10 "}>
